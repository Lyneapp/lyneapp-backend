...
public class ExceptionMessages {
    ...
    public static final String USER_ACCESS_REVOKED = "User access has been revoked"; // TODO Make this non-generic
    ...
    public static final String PHONE_NUMBER_MISMATCH = "This phone numbers entered deso not match";
    ...
    public static final String INVALID_PASSWORD = "XXXXXXXXXXXXXXXX";
    public static final String INVALID_EMAIL = "Invalid email";
    public static final String INVALID_PHONE_NUMBER = "Invalid phone number";
    public static final String INVALID_USERNAME = "XXXXXXXXXXXXXXXX";
